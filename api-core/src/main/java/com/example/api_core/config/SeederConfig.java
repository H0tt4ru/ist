        ...
        return _ -> {
            if (errorCodeRepository.count() == 0) {
                errorCodeRepository.saveAll(List.of(
                        ErrorCode.builder().code("4101").message("Broken request fields").build(),
                        ErrorCode.builder().code("4102").message("Empty fields").build(),
                        ErrorCode.builder().code("4103").message("Email already exists").build(),
                        ErrorCode.builder().code("4104").message(
                                "Password must have at least 8 characters, 1 uppercase, 1 lowercase, and 1 number")
                                .build(),
                        ErrorCode.builder().code("4105").message("Full name be no more than 100 characters").build(),
                        ErrorCode.builder().code("4106").message("Gender must be either Male or Female").build(),
                        ErrorCode.builder().code("4107").message("Invalid date of birth format").build(),
                        ErrorCode.builder().code("4108").message("Major must be one of the provided majors").build(),
                        ErrorCode.builder().code("4109")
                                .message("Phone number must be numbers only and minimum 7 digits").build(),
                        ErrorCode.builder().code("4110").message("Username must be no more than 20 characters").build(),
                        ErrorCode.builder().code("4200").message("Empty fields").build(),
                        ErrorCode.builder().code("4201").message("Wrong email or password").build(),
                        ErrorCode.builder().code("4300").message("Empty database").build(),
                        ErrorCode.builder().code("4301").message("Student not found").build(),
                        ErrorCode.builder().code("4302").message("Gender must be either Male or Female").build(),
                        ErrorCode.builder().code("4303").message("Invalid date of birth format").build(),
                        ErrorCode.builder().code("4304").message("Invalid major").build(),
                        ErrorCode.builder().code("4400").message("Empty fields").build(),
                        ErrorCode.builder().code("4401").message("Destination student not found").build(),
                        ErrorCode.builder().code("4402").message("Amount does not follow the rule").build(),
                        ...
                        ErrorCode.builder().code("4500")
                                ...
                                .build(),
                        ErrorCode.builder().code("4501").message("SentBy student not found").build(),
                        ErrorCode.builder().code("4502").message("ReceivedBy student not found").build(),
                        ErrorCode.builder().code("4600").message("JWT token is missing").build(),
                        ErrorCode.builder().code("4601").message("Invalid JWT token").build(),
                        ErrorCode.builder().code("4602").message("Expired JWT token").build(),
                        ErrorCode.builder().code("4603").message("Insufficient permissions").build(),
                        ErrorCode.builder().code("4604").message("Account locked").build(),
                        ErrorCode.builder().code("4700").message("Invalid email format").build(),
                        ErrorCode.builder().code("4701").message("Invalid password format").build(),
                        ErrorCode.builder().code("4702").message("Invalid phone number format").build(),
                        ErrorCode.builder().code("4703").message("Invalid date of birth format").build(),
                        ErrorCode.builder().code("4800").message("Duplicate key violation").build(),
                        ErrorCode.builder().code("4801").message("Foreign key violation").build(),
                        ErrorCode.builder().code("4802").message("Transaction failed").build(),
                        ErrorCode.builder().code("4900").message("External API timeout").build(),
                        ErrorCode.builder().code("4901").message("Invalid response from external service").build(),
                        ErrorCode.builder().code("4902").message("Unauthorized request to external service").build(),
                        ErrorCode.builder().code("4903").message("Inconsistent state").build(),
                        ErrorCode.builder().code("4904").message("Missing required field").build(),
                        ErrorCode.builder().code("5100").message("Rate limit exceeded – Too many requests").build(),
                        ErrorCode.builder().code("5101").message("API rate limit exceeded").build(),
                        ErrorCode.builder().code("5200").message("Feature not yet implemented").build(),
                        ErrorCode.builder().code("5201").message("Unknown error occurred").build(),
                        ErrorCode.builder().code("5000").message("Internal server error").build()));
            }
